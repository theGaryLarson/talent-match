...
const partnerCompanies = [
    {
        ...
        email: 'https://www.computingforall.org/contact-us/',
        websiteUrl: 'https://www.computingforall.org/',
        videoUrl: '',
        yearFounded: 2020,
        industrySector: 'Nonprofit',
        company_phone: '',
        mission: 'We seek to break down cultural and systemic social barriers that prevent young adults of all races, genders, and abilities from exploring computer science as a potential career. CFA’s employer-mentored, project-based work programs support practicing the application of critical thinking and problem-solving to real-world work scenarios.',
        vision: 'Diversity, equity, and inclusion are cornerstones for Computing for All. We are committed to a set of goals to increase workforce representation and to create a more inclusive culture.',
        size: '11-50',
        estimatedAnnualHires: 2,
        locationsByZip: ['98004']
    },
]
