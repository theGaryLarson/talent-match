import { CareerPrepApplicantEmailNotification, CareerPrepNotificationData } from '@/emails/career-prep-applicant-email-notification';
...
async function sendSingleCareerPrepApplicantEmailNotificationEmail(data:CareerPrepNotificationData){
    const component = CareerPrepApplicantEmailNotification(data);
