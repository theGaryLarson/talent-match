...
const jobSeekers = [
    ...
    },
    {
      ...
      "pfpPicSrc": "https://media.istockphoto.com/id/1467553187/photo/portrait-of-handsome-smiling-young-man-looking-at-camera.jpg?s=612x612&w=0&k=20&c=Vj5uyriPr8XlhRoFvEmIPBKwevab6aqMlMYjYyYTQfs=",
      "aboutMe": "Robotics engineer with a strong foundation in ROS, C++, Python, and MATLAB. Passionate about designing and programming autonomous systems. Committed to advancing robotics technology."
    },
    {
      "isLarge": true,
      "name": "Riley Black",
      ...
      "pfpPicSrc": "",
      "aboutMe": "Mobile Developer skilled in Swift, Kotlin, Flutter, and React Native. Focused on creating intuitive and efficient mobile applications. Passionate about mobile technology and user experience."
    },
    {
      "isLarge": true,
      "name": "Jamie Gray",
      ...
      "pfpPicSrc": "",
      "aboutMe": "Cloud Computing expert with experience in AWS, Azure, GCP, and Terraform. Skilled in cloud infrastructure and deployment automation. Committed to optimizing cloud resources and performance."
    },
    {
      "isLarge": true,
      "name": "Peyton Reed",
      ...
      "pfpPicSrc": "",
      "aboutMe": "DevOps Engineer experienced with Jenkins, Docker, Kubernetes, and Ansible. Passionate about automating and streamlining development processes. Focused on improving efficiency and collaboration."
    },
    {
      "isLarge": true,
      "name": "Quinn Davis",
