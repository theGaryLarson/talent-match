            ...
            <div>
              ...
              <FormControl component="fieldset">
                ...
                >
                  ...
                  />
                  <FormControlLabel
                    value="Software Quality Assurance Analyst and Tester"
                    control={<Radio />}
                    label="Software Quality Assurance Analyst and Tester"
                  />
                  <FormControlLabel
                    value="Network and Computer Systems Administrator"
                    control={<Radio />}
                    label="Network and Computer Systems Administrator"
                  />
                  <FormControlLabel
                    value="Computer User Support Specialist"
                    control={<Radio />}
                    label="Computer User Support Specialist"
                  />
                  <FormControlLabel
