export default function Teaser({isLarge, title, text}:{isLarge:Boolean, title:string, text:string}){
    if(isLarge){
        return(
            <div className="w-[300px] 2xl:w-[350px] h-[400px] rounded-xl border flex flex-col">
            <div className="w-[300px] 2xl:w-[350px] h-[150px] 2xl:h-[200px] rounded-t-lg bg-black"></div>
            <div className="w-[300px] 2xl:w-[350px] h-[250px] 2xl:h-[200px] p-4 space-y-6">
