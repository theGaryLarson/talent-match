...
import { companies, industry_sectors, job_postings, skills, technology_areas } from "@prisma/client";
...
export default function UpdateJobListingForm() {
  const [joblistings, setJobListings] = useState<(job_postings&{skills:skills[]})[]>([]);
  ...
  useEffect(() => {
    fetch("/api/joblistings/getall").then((res) => res.json()).then(setJobListings);
    fetch("/api/companies/getall").then((res) => res.json()).then(setCompanies);
    fetch("/api/joblistings/sectors").then((res) => res.json()).then(setIndustrySectors);
    fetch("/api/joblistings/techarea").then((res) => res.json()).then(setTechAreas);
  }, []);
  useEffect(() => {
    if (quill) {
      quill.clipboard.dangerouslyPasteHTML(formData.job_description)
      quill.on("text-change", () => {
        setFormData((prev)=> ({...prev, job_description:quill.root.innerHTML}))
      });
    }
  }, [quill]);
  return (
      ...
      </div>
  {
    selectedJob && (
      ...
      <div className="grid grid-cols-1">
        ...
        <select name="company" id="company" required value={formData.company_id} onChange={handleChange}>
      ...
      <div className="grid grid-cols-1">
            ...
            <select name="sector_id" value={formData.sector_id} onChange={handleChange} required>
              ...
              {industrySectors.map((sector) => (
                <option key={sector.industry_sector_id} value={sector.industry_sector_id}>{sector.sector_title}</option>
              ))}
            </select>
          </div>
      {/*Tech Area*/}
      <div className="grid grid-cols-1">
            ...
            <select name="tech_area_id" value={formData.tech_area_id} onChange={handleChange} required>
      ...
      <div>
        ...
        <div>
          <label>
            <input type="radio" name="is_internship" value="yes" required checked={formData.is_internship} onChange={handleChange}/>
            Yes
          </label>
          <label>
            <input type="radio" name="is_internship" value="no" required checked={!formData.is_internship} onChange={handleChange}/>
            No
          </label>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <label>
            <input type="radio" name="is_apprenticeship" value="yes" required  checked={formData.is_apprenticeship} onChange={handleChange}/>
            Yes
          </label>
          <label>
            <input type="radio" name="is_apprenticeship" value="no" required checked={!formData.is_apprenticeship} onChange={handleChange}/>
            No
          </label>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <label>
            <input type="radio" name="is_paid" value="yes" required checked={formData.is_paid} onChange={handleChange}/>
            Yes
          </label>
          <label>
            <input type="radio" name="is_paid" value="no" required  checked={!formData.is_paid} onChange={handleChange}/>
            No
          </label>
        </div>
      </div>
      <div>
        ...
        <div>
          <label>
            <input type="radio" name="relocation" value="yes" required checked={formData.relocation_services} onChange={handleChange}/>
            Yes
          </label>
          <label>
            <input type="radio" name="relocation" value="no" required  checked={!formData.relocation_services} onChange={handleChange}/>
            No
          </label>
        </div>
      </div>
      <div>
        ...
        <div>
          <label>
            <input type="radio" name="visas" value="yes" required checked={formData.visa_sponsership} onChange={handleChange}/>
            Yes
          </label>
          <label>
            <input type="radio" name="visas" value="no" required checked={!formData.visa_sponsership} onChange={handleChange}/>
            No
          </label>
        </div>
      </div>
      ...
      <div>
        ...
        <select name="employment_type" defaultValue={formData.employment_type} onChange={handleChange}>
      ...
      <div>
        ...
        <div>
          <label>
            <input type="radio" name="location" value="remote" required checked={formData.location == 'remote'} onChange={handleChange}/>
            Remote
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="location" value="on-site"  checked={formData.location == 'on-site'} onChange={handleChange}/>
            On-Site
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="location" value="hybrid"  checked={formData.location == 'hybrid'} onChange={handleChange}/>
            Hybrid
          </label>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1">
        ...
        <input type="text" name="salary_range" required value={formData.salary_range} onChange={handleChange} />
      </div>
      ...
      <div className="grid grid-cols-1">
        ...
        <input type="text" name="job_post_url" value={formData.job_post_url} onChange={handleChange}/>
      </div>

      {/* Assessment URL */}
      <div>
        <label htmlFor="assessment_url">Assessment URL</label>
        <input type="text" name="assessment_url" value={formData.assessment_url} onChange={handleChange}/>
      </div>
