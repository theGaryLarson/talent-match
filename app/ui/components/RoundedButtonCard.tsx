...
export default function RoundedButtonCard(props: {
  ...
  return (
    <div className="border-box flex max-w-[400px] min-w-[375px] flex-col space-y-3 rounded-2xl border border-solid border-black px-5 py-5 shadow">
      <h3 className='text-primary-600 font-bold text-lg'>{props.title}</h3>
      <p>{props.desc}</p>
      <p><Link className='text-primary-600' href={props.link}>{props.callToAction}</Link></p>
