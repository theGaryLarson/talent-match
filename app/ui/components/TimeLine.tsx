  ...
  return (
    <>
      <div className="hidden h-[1028.07px] items-center justify-center gap-[30px] tablet:inline-flex ">
        ...
        <div className="relative h-[903.17px] w-[15px]">
          <svg
            className="absolute left-[5.5px] top-[0px]"
            width="4"
            height="891"
            viewBox="0 0 4 891"
            fill="none"
        ...
        <div className="relative h-[1023.52px] w-[400.49px]">
          <div className="absolute left-[0.49px] top-0 inline-flex h-[135.52px] w-[400px] flex-col items-start justify-start gap-5">
            ...
            <div className="self-stretch font-['Roboto'] text-xl font-normal leading-snug text-black">
              Build a personalized career plan to strengthen skills and land a
              tech job
            </div>
          </div>
          <div className="absolute left-[0.49px] top-[296px] inline-flex h-[135.52px] w-[400px] flex-col items-start justify-start gap-5">
            ...
            <div className="self-stretch font-['Roboto'] text-xl font-normal leading-snug text-black">
              Build skills to confidently navigate the job market and expand
          ...
          <div className="absolute left-0 top-[888px] inline-flex h-[135.52px] w-[400px] flex-col items-start justify-start gap-5">
            ...
            <div className="self-stretch font-['Roboto'] text-xl font-normal leading-snug text-black">
              Impress ready-to-hire employers in our Tech Workforce
              Coalition Network
            </div>
          </div>
        </div>
      ...
      <div className="tablet:hidden inline-flex h-[342px] flex-col items-start justify-start gap-[30px]">
        <div className="flex h-[59px] flex-col items-center justify-start self-stretch rounded-[20px] px-8">
          ...
          <div className="flex flex-col items-start justify-start">
            <div className="relative h-2 w-px" />
          </div>
          <div className="inline-flex items-center justify-center gap-2.5 self-stretch">
            <div className="shrink grow basis-0 self-stretch text-center font-['Roboto'] text-[13px] font-normal leading-none tracking-tight text-black">
              Build a personalized career plan to strengthen skills and land a
              tech job
            </div>
          </div>
        ...
        <div className="flex h-[75px] flex-col items-center justify-start self-stretch rounded-[20px] px-8">
          ...
          <div className="inline-flex items-center justify-center gap-2.5 self-stretch">
            <div className="shrink grow basis-0 self-stretch text-center font-['Roboto'] text-[13px] font-normal leading-none tracking-tight text-black">
              Build skills with events to confidently navigate the job market
        ...
        <div className="flex h-[59px] flex-col items-center justify-start self-stretch rounded-[20px] px-8">
          ...
          <div className="inline-flex items-center justify-center gap-2.5 self-stretch">
            <div className="shrink grow basis-0 text-center font-['Roboto'] text-[13px] font-normal leading-none tracking-tight text-black">
              Impress ready-to-hire employers in our Tech Workforce
              Coalition Network
            </div>
          </div>
