        ...
        <div className="w-full bg-neutral-100 flex-col justify-start items-center inline-flex">
            ...
            <div className="w-full px-32 bg-white flex-col justify-start items-center gap-2.5 flex">
                ...
                <div className="w-full flex-col justify-center items-start gap-2.5 flex">
                    ...
                    <div className="text-zinc-900 text-base font-normal font-['Roboto'] leading-tight">Jumpstart your journey with hands-on, industry-aligned training. These partner programs offer the skills, mentorship, and credentials you need to succeed in your chosen tech career.</div>
