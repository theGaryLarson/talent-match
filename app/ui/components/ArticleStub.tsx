...
export default function ArticleStub({
  ...
  return (
    <div
      className={`flex flex-row ${isPhotoFirst ? "" : "flex-row-reverse"} justify-evenly flex-wrap gap-[42px] desktop:justify-evenly laptop:flex-nowrap`}
    >
      <Image
      ...
      <div className="max-w-[600px] flex flex-col gap-[32px]">
        ...
        <Link href={"/#"}>Cick here to learn more</Link>
      </div>
    </div>
  );
}
