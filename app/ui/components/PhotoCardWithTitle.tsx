    ...
    <div className="text-sm bg-white rounded-2xl border border-black shadow box-border relative">
      <div className="w-1/1 flex items-center">
        <Image
          ...
          alt={""}
        />
        <div className="h-[34px] absolute top-3/8 left-0 bg-blue-trans rounded-tr-md rounded-br-md flex items-center">
          <h3 className="text-lg text-white font-bold px-3">{title}</h3>
        </div>
      </div>
