...
<div className="w-[621.30px] h-[399.84px] relative">
    ...
    <span className="w-[221.62px] h-[42.92px] left-[320.42px] top-[356.92px] absolute rounded-[7.07px] shadow flex items-center justify-center bg-white border border-black">ADD WORK EXPERIENCE</span>
