...
const CareerDropDownInfo = [
  {
    name: 'Career Services Landing Page',
    description: 'Learn What Career Services has to Offer',
    href: '/services',
    icon: ChartPieIcon,
  },
  {
    name: 'Employer Landing Page',
    description: 'Mange your canidate search',
  ...
  },
  {
    ...
    description: 'Mange your job search',
    href: '/services/jobseekers/dashboard',
    icon: CursorArrowRaysIcon,
  },
  {
    name: 'Upcoming Info Sessions',
  ...
  },
  {
    ...
    description: 'Build Projects with guidance from mentors',
    href: '/underconstruction',
