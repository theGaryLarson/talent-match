...
export interface IRelatedData {
  cfa_jobpostingsregionalbreakdown_Occupation: {
  ...
  cfa_experiencebreakdown_Occupation: {
    cfa_experience: string;
    cfa_percentoftotal: string;
  }[];
  cfa_educationbreakdown_Occupation: {
    cfa_educationlevel: string;
    cfa_percentoftotal: string;
  }[];
  cfa_advertisedwagetrend_Occupation: {
    cfa_monthyear: string;
    cfa_advertisedwage: string;
  }[];
