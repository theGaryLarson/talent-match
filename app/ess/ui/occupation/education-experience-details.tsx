...
export default function EducationExperienceDetails({
    ...
    const education_items = occupation.cfa_educationbreakdown_Occupation.map(education => ({
        label: education.cfa_educationlevel,
        value: Number(education.cfa_percentoftotal),
    }));
    const experience_items = occupation.cfa_experiencebreakdown_Occupation.map(experience => ({
