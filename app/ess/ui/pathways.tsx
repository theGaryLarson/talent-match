              ...
              pathwaysData.map((item) => (
                <ListItem disablePadding divider key={item.cfa_pathwayid}>
                  <ListItemButton
                    ...
                    sx={{
                      backgroundColor:
                        selectedCardId === item.cfa_pathwayid
          ...
          <List disablePadding>
            {selectedCardId && occupationsData.length > 0 ? (
              occupationsData.map((occupation, index) => (
                <Card
                  key={index + occupation.cfa_occupationid}
                  sx={{
                    marginBottom: 2,
                    borderWidth: "2px",
                    borderStyle: "solid",
                ...
                >
                  <CardContent>
                    ...
                    <Typography>
                      {occupation.cfa_whattheydo &&
                        truncateText(occupation.cfa_whattheydo, 400)}
                    </Typography>
                    <Box
                      display="flex"
                    ...
                    >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          router.push(
                            `/ess/occupation/${occupation.cfa_occupationid}`,
                          )
                        }
