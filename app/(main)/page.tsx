        ...
        <div>
            <div className="py-8 mx-0 tablet:mx-8 laptop:mx-16 font-['Roboto']">
                ...
                <div className="w-full relative inline-flex justify-center items-center">
                    <Image src="/images/landing/banner.jpg" width={4096} height={2213} alt="Stock photo" className="w-11/12 tablet:w-3/4 z-50 rounded-3xl shadow"/>
                    ...
                    <div className="mt-8 px-4 laptop:px-24 flex-col justify-start items-center gap-5 inline-flex">
                            ...
                            <div className="justify-center items-center gap-12 mt-10 mb-20 flex-col laptop:flex-row laptop:inline-flex">
                                <div className="flex-col justify-center items-center gap-6 flex">
                                    <div className="w-full mb-6 h-36 flex justify-center items-center">
                                        <Image src="/images/landing/TWC-logo.svg" width={242} height={155} alt="TWC logo" className="w-1/2 sm-tablet:w-1/4 laptop:w-full"/>
                                    </div>
                            ...
                            <div className="w-full desktop:w-3/4 pt-8 pb-0 laptop:pb-8 pl-8 pr-8 laptop:pr-0 bg-sky-950 rounded-3xl justify-start items-center gap-20">
                                <div className="w-full laptop:grid laptop:grid-cols-2 justify-center items-start gap-2.5">
                                    <div className="">
                                        ...
                                        <div className="text-4xl sm-tablet:text-6xl leading-none mb-4 sm-tablet:mb-12 self-stretch text-neutral-100 font-normal font-['Roboto'] capitalize leading-10">Talent Portal</div>
                                        <div className="text-2xl sm-tablet:text-5xl mb-8 self-stretch text-sky-200 font-normal font-['Roboto'] capitalize leading-10">Hire Qualified Candidates</div>
                                    ...
                                    <Image src="/images/landing/my-dashboard.png" width={2356} height={2316} alt="Dashboard preview" className="hidden laptop:block h-full object-cover object-left rounded-tl-3xl rounded-bl-3xl"/>
                                </div>
                                <Image src="/images/landing/my-dashboard.png" width={2356} height={2316} alt="Dashboard preview" className="laptop:hidden mt-10 w-full aspect-square sm-tablet:aspect-auto sm-tablet:h-[36rem] object-cover object-left-top rounded-tl-3xl rounded-tr-3xl"/>
                            </div>
                        </div>
                        {/* Our goal */}
                        ...
                        <div className="mt-4 laptop:mt-10 mx-4 self-stretch justify-center items-center gap-12 inline-flex">
                            <div className="w-full laptop:w-2/3 flex-col justify-center items-start gap-2.5 inline-flex">
                                <Image src="/images/landing/what-we-do.jpg" width={4096} height={2731} alt="What we do" className="laptop:hidden mb-4 w-full aspect-square rounded-3xl shadow object-cover"/>
                                ...
                                <div className="text-4xl sm-tablet:text-6xl leading-none self-stretch text-cyan-700 font-normal font-['Roboto'] capitalize leading-10">Build A more inclusive tech future</div>
                            ...
                            <Image src="/images/landing/what-we-do.jpg" width={4096} height={2731} alt="What we do" className="hidden laptop:block w-96 h-96 rounded-3xl shadow object-cover"/>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full mt-20 laptop:mt-40 px-8 laptop:px-24 flex-col justify-start items-center gap-3.5 inline-flex">
                ...
                <div className="self-stretch justify-center items-start gap-12 inline-flex">
                    <div className="hidden laptop:block justify-center items-center gap-24 flex">
                        <div className="w-96 h-96 relative">
                            <div className="w-96 h-96 left-[0.58px] top-[-0px] absolute">
                                <Image src="/images/landing/for-employers.jpg" width={1911} height={1505} alt="Stock photo of job candidate" className="hidden laptop:block w-96 shadow-none"/>
                            </div>
                        </div>
                    </div>
                    <div className="w-full laptop:w-1/2 flex-col justify-center items-start gap-2.5 inline-flex">
                        ...
                        <Image src="/images/landing/for-employers.jpg" width={1911} height={1505} alt="Stock photo of job candidate" className="laptop:hidden w-full shadow-none"/>
                ...
                <div className="mt-24 laptop:mt-16 w-full self-stretch justify-center items-start gap-12 inline-flex">
                    ...
                    <Image src="/images/landing/for-educators.jpg" width={4096} height={2731} alt="Stock photo of student" className="hidden laptop:block w-96 h-96 rounded-3xl object-cover"/>
                </div>
                {/* For job candidates */}
                <div className="mt-24 laptop:mt-16 self-stretch justify-center items-start gap-12 inline-flex">
                    <Image src="/images/landing/for-job-candidates.jpg" width={1751} height={1297} alt="Stock photo of job candidate" className="hidden laptop:block w-96"/>
                    <div className="w-full laptop:w-1/2 flex-col justify-center items-start gap-2.5 inline-flex">
                        <div className="px-4 py-2 bg-[#D6F1F7] rounded-2xl justify-start items-center gap-2.5 inline-flex">
                        ...
                        <Image src="/images/landing/for-job-candidates.jpg" width={1751} height={1297} alt="Stock photo of job candidate" className="laptop:hidden w-full shadow-none"/>
