        ...
        <div>
            <main className="py-8 mx-4 tablet:mx-[150px] laptop:mx-[200px] font-['Roboto']">
                ...
                <div className="w-full py-10 px-24 rounded-3xl flex-col justify-center items-center gap-5 inline-flex">
                    ...
                    <div className="REPLACE-BEFORE-RELEASE justify-start items-start gap-5 inline-flex">
                        ...
                        <div className="p-4 flex-col justify-start items-center flex">
                            ...
                            <div className="h-56 justify-center items-center gap-12 mt-10 mb-20 inline-flex">
                                ...
                                <div className="grow shrink basis-0">
                                    <span className="text-gray-900 text-xl font-normal font-['Roboto'] leading-loose">The </span><span className="REPLACE-BEFORE-RELEASE text-cyan-700 text-xl font-semibold font-['Roboto'] leading-loose">Washington Tech Workforce Coalition</span>
                                    ...
                                    <div className="">
                                        ...
                                        <div className="justify-start items-start gap-5 inline-flex">
                                            <div className="px-5 py-3 bg-cyan-700 rounded-full justify-center items-center gap-2 flex">
                                                <div className="REPLACE-BEFORE-RELEASE text-center text-white text-base font-medium font-['Roboto'] leading-tight tracking-tight">Join the Coalition</div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div className="w-full h-80 px-24 pb-4 bg-neutral-100 flex-col justify-center items-center gap-5 inline-flex">
