    ...
    <main className="w-6/12">
      ...
      {selectedCompany && (
        <form onSubmit={onSubmit} className='space-y-3'>
          ...
          <div className="grid grid-cols-1">
            <label htmlFor="industry_sector_id">What Tech Sector does this Company fall under?</label>
            <select
          ...
          <div className="grid grid-cols-1">
            <label htmlFor="company_website_url">Company URL <span className='text-xs'>(http:// required)</span></label>
            <input
              type='url'
          ...
          <div className="grid grid-cols-1">
            <label htmlFor="estimated_annual_hires">Estimated Annual Hires</label>
            <input
              type="number"
