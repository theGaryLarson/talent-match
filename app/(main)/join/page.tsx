...
export default function Page(): JSX.Element {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        const payload: PayloadData = {
            ...
            "Notification": "This is a notification that a contact form was submitted on your website (Washington Tech Workforce Coalition)"
        };

        try {
            const response = await fetch('https://prod-25.westus.logic.azure.com:443/workflows/b1c10acdf2324ab097420749954854e9/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=X297QuDQs7HctPalrTQIJ9Nh7-5TDUHhdnS51R1eb54', {
                method: 'POST',
                headers: {
            ...
            <Container maxWidth="lg" sx={{ py: 4 }}>
                <Box component="form" onSubmit={handleSubmit} sx={{ mt: 2 }}>
                    ...
                    <Typography variant="subtitle1" align="center" sx={{ mb: 4 }}>
                        Membership is FREE. Join us in building a workforce that evolves at the rate of technology advancement.
                    </Typography>
