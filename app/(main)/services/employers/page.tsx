  ...
  return (
    <>
      ...
      <main className="mx-4 space-y-3 py-8 font-['Roboto'] md:mx-[150px] lg:mx-[200px]">
        ...
        <p>
          Computing for All partners with Washington state community and
          technical colleges and training providers to source diverse students
          and job seekers for tech careers. We also train candidates in
          professional skill development to ensure they are career-ready.
        </p>
