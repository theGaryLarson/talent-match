  ...
  return (
    <>
      ...
      <main className="mx-4 space-y-3 py-8 font-['Roboto'] tablet:mx-[150px] laptop:mx-[200px]">
        ...
        <div><h1 className="text-2xl font-bold">Hire the Right Candidate</h1>
          <p>
          ...
          <div className="pt-2">
            <RoundedButton content={"Browse Job Seekers"} link={"/services/employers/dashboard/listview"} invertColor={true} />
          </div>
        </div>
