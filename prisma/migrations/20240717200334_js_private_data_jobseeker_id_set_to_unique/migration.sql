/*
  ...
  - A unique constraint covering the columns `[jobseeker_id]` on the table `jobseekers_private_data` will be added. If there are existing duplicate values, this will fail.
