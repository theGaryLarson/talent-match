/*
  ...
  - A unique constraint covering the columns `[pathway_title]` on the table `pathways` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
ALTER TABLE [dbo].[pathways] ADD CONSTRAINT [pathways_pathway_title_key] UNIQUE NONCLUSTERED ([pathway_title]);
