/*
  ...
  - Added the required column `ed_program` to the `jobseekers_education` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE [dbo].[jobseekers_education] ADD [ed_program] NVARCHAR(45) NOT NULL;
