/*
  ...
  - A unique constraint covering the columns `[name]` on the table `edu_institutions` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
ALTER TABLE [dbo].[edu_institutions] ADD CONSTRAINT [edu_institutions_name_key] UNIQUE NONCLUSTERED ([name]);
