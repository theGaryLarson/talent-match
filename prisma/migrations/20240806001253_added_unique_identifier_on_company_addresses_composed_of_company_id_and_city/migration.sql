/*
  ...
  - A unique constraint covering the columns `[company_id,city]` on the table `company_addresses` will be added. If there are existing duplicate values, this will fail.
