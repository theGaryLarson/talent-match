...
CREATE TABLE [dbo].[case_mgmt] (
    [case_mgmt_id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [case_mgmt_case_mgmt_id_df] DEFAULT newid(),
    [jobseeker_learner_id] UNIQUEIDENTIFIER NOT NULL,
...
CREATE TABLE [dbo].[company_addresses] (
    ...
    [city] VARCHAR(255),
    [state] VARCHAR(255),
    [zip_region] VARCHAR(10) NOT NULL,
    [county] VARCHAR(255),
    CONSTRAINT [company_addresses_PRIMARY] PRIMARY KEY NONCLUSTERED ([company_address_id]),
    CONSTRAINT [company_addresses_company_id_city_unique] UNIQUE NONCLUSTERED ([company_id],[city])
);
...
CREATE TABLE [dbo].[user_addresses] (
    ...
    [city] VARCHAR(255),
    [county] VARCHAR(255),
    CONSTRAINT [contact_addresses_PRIMARY] PRIMARY KEY NONCLUSTERED ([user_address_id]),
...
CREATE TABLE [dbo].[job_listing_has_skills] (
    [job_listing_has_skill_id] UNIQUEIDENTIFIER NOT NULL,
    [job_listing_id] UNIQUEIDENTIFIER NOT NULL,
...
CREATE TABLE [dbo].[jobseekers] (
    ...
    [pool1] BIT NOT NULL CONSTRAINT [jobseekers_pool1_df] DEFAULT 0,
...
CREATE TABLE [dbo].[jobseekers_private_data] (
    ...
    [jobseeker_id] UNIQUEIDENTIFIER NOT NULL,
    [ssn] VARCHAR(255),
    [is_authorized_to_work_in_usa] BIT NOT NULL CONSTRAINT [DF__jobseeker__is_au__3C34F16F] DEFAULT 0,
    [job_sponsorship_required] BIT NOT NULL CONSTRAINT [DF__jobseeker__job_s__3D2915A8] DEFAULT 0,
    [is_veteran] VARCHAR(45) NOT NULL CONSTRAINT [DF__jobseeker__is_ve__3E1D39E1] DEFAULT 'prefer not to say',
...
CREATE TABLE [dbo].[jobseekers_skill_gap_data] (
    [jobseeker_skill_gap_data_id] UNIQUEIDENTIFIER NOT NULL,
    [jobseeker_id] UNIQUEIDENTIFIER NOT NULL,
...
CREATE TABLE [dbo].[learner_proj_based_tech_assessment] (
    [learner_proj_based_tech_assessment_id] UNIQUEIDENTIFIER NOT NULL,
    [jobseeker_id] UNIQUEIDENTIFIER NOT NULL,
    [proj_based_tech_assessment_id] UNIQUEIDENTIFIER NOT NULL,
    [attempt_date] DATETIME NOT NULL,
    [has_passed] BIT NOT NULL,
