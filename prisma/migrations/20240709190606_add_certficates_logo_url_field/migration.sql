/*
  ...
  - Added the required column `logo_url` to the `certificates` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE [dbo].[certificates] ADD [logo_url] VARCHAR(255) NOT NULL;
