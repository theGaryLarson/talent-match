/*
  ...
  - You are about to drop the column `user_email` on the `edu_institutions` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE [dbo].[edu_institutions] DROP COLUMN [user_email];
ALTER TABLE [dbo].[edu_institutions] ADD [contact_email] VARCHAR(255);
...
-- AlterTable
EXEC SP_RENAME N'dbo.user_addresses_PRIMARY', N'contact_addresses_PRIMARY';
