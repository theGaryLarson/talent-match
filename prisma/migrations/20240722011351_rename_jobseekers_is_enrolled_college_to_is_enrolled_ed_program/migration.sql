/*
  ...
  - You are about to drop the column `is_enrolled_college` on the `jobseekers` table. All the data in the column will be lost.
  - Added the required column `is_enrolled_ed_program` to the `jobseekers` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE [dbo].[jobseekers] DROP COLUMN [is_enrolled_college];
ALTER TABLE [dbo].[jobseekers] ADD [is_enrolled_ed_program] BIT NOT NULL;
