/*
  ...
  - Added the required column `employer_id` to the `company_social_links` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE [dbo].[company_social_links] ADD [employer_id] NVARCHAR(36) NOT NULL;
