...
-- AlterTable
ALTER TABLE [dbo].[company_addresses] ALTER COLUMN [city] VARCHAR(255) NULL;
ALTER TABLE [dbo].[company_addresses] ALTER COLUMN [state] VARCHAR(255) NULL;
ALTER TABLE [dbo].[company_addresses] ALTER COLUMN [county] VARCHAR(255) NULL;
