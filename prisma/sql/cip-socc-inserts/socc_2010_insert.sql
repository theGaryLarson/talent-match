...
BEGIN TRY
    ...
    INSERT INTO [dbo].[socc_2010] (socc_code, title, description)
    SELECT v.socc_code, v.title, NULL
    FROM (VALUES ('999999', 'No Match'),
                 ...
                 ('553019',
                  'Military Enlisted Tactical Operations and Air/Weapons Specialists and Crew Members, All Other')) AS v(socc_code, title)
    WHERE NOT EXISTS (SELECT 1
                      FROM [dbo].[socc_2010] t
