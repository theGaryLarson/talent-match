import {
  ...
  export const EmployerNeedsVerificationEmail = ({ name }: EmployerNeedsVerificationData) => (
    <Html>
      <Head />
      ...
      <Tailwind>
        <Body className="m-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Text className="text-[14px] leading-[24px] text-black">
              A new employer or company has been created on the portal and may need to be approved by CFA staff
            </Text>
